...
public class mainControl {
    ...
    void setShip4(ActionEvent event) throws FileNotFoundException {
    	...
    	//Buttons ausblenden und navigieren ermöglichen
    	hideButtons(3);
	...
	private void renderField()
	{
		for (int i=0;i<10;i++)
		{
			for (int j=0;j<10;j++)
			{
				this.player_field.add(new ImageView(this.gfPlayer[i][j].getImage()),i,j);
			}
		}
	}
    ...
    {
    	//Spieler Felder mit Wasser füllen
    	for (int y=0;y<10;y++)
    	{
    		for (int x=0;x<10;x++)
        	{
